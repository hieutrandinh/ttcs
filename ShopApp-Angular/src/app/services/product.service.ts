...
export class ProductService {
  ...
  createProduct(productData: any): Observable<any> {
    return this.http.post(this.apiGetProducts, productData);
  }

  updateProduct(id: number, productData: any): Observable<any> {
    return this.http.put(`${this.apiGetProducts}/${id}`, productData);
  }

  deleteProduct(id: number): Observable<any> {
    return this.http.delete(`${this.apiGetProducts}/${id}`, {
      responseType: 'text',
    });
  }
}
